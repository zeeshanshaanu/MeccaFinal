...
const AllFaqs = () => {
  ...
  const AddfaqCatg = () => {
    ...
    formData.append("name", name);
     axios
      .post("/quoraCategory/add", formData, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token_id")}`,
        },
      })
  ...
  ////////////=============/////////////============
  ////////////=============/////////////============
  const handleDelete = (quora_category_id) => {
    console.log(sessionStorage.getItem("token_id"));
    setdone(true);
    axios
      .delete(`/quoraCategory/delete?quora_category_id=${quora_category_id}`, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token_id")}`,
        },
      })
                      ...
                      <Table className="w-100">
                        ...
                        <tbody>
                          {Blog.filter((admin) => {
                            ...
                            <tr>
                              <td>{index.quora_category_id}</td>
                              <td>{index.name}</td>
                              <td className="w-25">{index.description}</td>
                              ...
                              <td>
                                <div className="d-flex icon-popup">
                                  <EditIcon
                                    ...
                                    onClick={() => {
                                      navigate(
                                        `/UpdateQuoraFaqCategory/${index.quora_category_id}`
                                      );
                                    }}
                                  />  
                                  <div
                                    ...
                                    onClick={() => {
                                      handleDelete(index.quora_category_id);
                                    }}
                                  >
                                    <DeleteIcon />
                                  </div>
