...
const AllEventCategories = () => {
  ...
  const AddAdminServices = () => {
    ...
    axios
      .post("/eventCategory/add", formData, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token_id")}`,
        },
      })
  ...
  ////////////=============/////////////============
  ////////////=============/////////////============
  const handleDelete = (event_category_id) => {
    console.log(sessionStorage.getItem("token_id"));
    setdone(true);
    axios
      .delete(`/eventCategory/delete?event_category_id=${event_category_id}`, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token_id")}`,
        },
      })
                ...
                <Form onSubmit={HandleSubmit} className="">
                  <div class="">
                    ...
                    <div className="">
                      ...
                      {/* <Col lg={4} md={6} sm={12}> */}
                      <div className="">
                        <h4 className="fw-bolder">Add&nbsp;Event Category</h4>
                        <Form.Label className="text-dark">
                          Event Category Name*
                        </Form.Label>
                      </div>
                                ...
                                <td>
                                  <div className="d-flex icon-popup">
                                    <EditIcon
                                      ...
                                      onClick={() => {
                                        navigate(
                                          `/UpdateEventCategory/${index.event_category_id}`
                                        );
                                      }}
                                    />
                                    <div
                                      ...
                                      onClick={() => {
                                        handleDelete(index.event_category_id);
                                      }}
                                    >
                                      <DeleteIcon />
                                    </div>
