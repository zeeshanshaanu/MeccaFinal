...
const AllProductCategories = () => {
  ...
  const AddAdminServices = () => {
    ...
    axios
      .post("/productCategory/add", formData, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token_id")}`,
        },
      })
  ...
  ////////////=============/////////////============
  ////////////=============/////////////============
  const handleDelete = (product_category_id) => {
    console.log(sessionStorage.getItem("token_id"));
    setdone(true);
    axios
      .delete(
        `/productCategory/delete?product_category_id=${product_category_id}`,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token_id")}`,
          },
                      ...
                      <Table className="w-100">
                        ...
                        <tbody>
                          {Services.filter((admin) => {
                            ...
                            <tr>
                              <td>{index.product_category_id}</td>
                              <td>{index.name}</td>
                              ...
                              <td>
                                <div className="d-flex icon-popup">
                                  <EditIcon
                                    ...
                                    onClick={() => {
                                      navigate(
                                        `/UpdateService/${index.product_category_id}`
                                      );
                                    }}
                                  />
                                  <div
                                    ...
                                    onClick={() => {
                                      handleDelete(index.product_category_id);
                                    }}
                                  >
                                    <DeleteIcon />
                                  </div>
